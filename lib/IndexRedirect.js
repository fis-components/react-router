...
var IndexRedirect = (function (_Component) {
  ...
  IndexRedirect.prototype.render = function render() {
    !false ? true ? _invariant2['default'](false, '<IndexRedirect> elements are for router configuration only and should not be rendered') : _invariant2['default'](false) : undefined;
  };
