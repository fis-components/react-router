...
(function webpackUniversalModuleDefinition(root, factory) {
    ...
    module.exports = factory(require('react')) || module.exports;;
                ...
                for (var propName in propTypes) {
                    if (propTypes.hasOwnProperty(propName)) {
                        ...
                        if (error instanceof Error)
                            false ? _warning2['default'](false, error.message) : undefined;
                    }
                }
            }
	 ...
	 */
        ...
        function (module, exports, __webpack_require__) {
            ...
            var component = oneOfType([
                func,
                string
            ]);
            exports.component = component;
            var components = oneOfType([
                component,
                object
            ]);
        ...
        function (module, exports, __webpack_require__) {
            ...
            function _compilePattern(pattern) {
                ...
                var paramNames = [];
                var tokens = [];
                var match = undefined, lastIndex = 0, matcher = /:([a-zA-Z_$][a-zA-Z0-9_$]*)|\*\*|\*|\(|\)/g;
	 ...
	 */
            function matchPattern(pattern, pathname) {
                ...
                var remainingPathname = undefined, paramValues = undefined;
                if (match != null) {
                    if (captureRemaining) {
	 ...
	 */
            function formatPattern(pattern, params) {
                ...
                var token = undefined, paramName = undefined, paramValue = undefined;
	 ...
	 */
            function useRoutes(createHistory) {
                return function () {
                    ...
                    var unlistenBefore = undefined, unlistenBeforeUnload = undefined;
                    /**
	 ...
	 */
            function computeChangedRoutes(prevState, nextState) {
                ...
                var leaveRoutes = undefined, enterRoutes = undefined;
                if (prevRoutes) {
        ...
        function (module, exports, __webpack_require__) {
            ...
            function createHashHistory() {
                ...
                function getCurrentLocation() {
                    var path = _DOMUtils.getHashPath();
                    var key = undefined, state = undefined;
                    if (queryKey) {
                ...
                var listenerCount = 0, stopHashChangeListener = undefined;
	 ...
	 */
            function useQueries(createHistory) {
                return function () {
                    ...
                    var historyOptions = _objectWithoutProperties(options, [
                        'stringifyQuery',
                        'parseQueryString'
                    ]);
                    var history = createHistory(historyOptions);
