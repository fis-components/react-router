...
var IndexRoute = (function (_Component) {
  ...
  IndexRoute.prototype.render = function render() {
    !false ? true ? _invariant2['default'](false, '<IndexRoute> elements are for router configuration only and should not be rendered') : _invariant2['default'](false) : undefined;
  };
